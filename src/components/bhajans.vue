<template>
  <div>
    ...
    <div class="sticky top-0 flex items-center justify-center space-x-3">
      <vue-fuse
        v-model="searchTerm"
        :keys="keys"
        :list="all"
        ...
        :defaultAll="false"
        eventName="results"
        class="p-4 my-10 text-2xl text-center border border-gray-200 shadow-lg"
      ></vue-fuse>
    ...
    <div class="grid md:grid-cols-3 ">
      <div
        ...
        :key="bhajan.id"
        class="grid p-10 font-serif text-xl font-medium shadow-lg place-items-center"
      >
        <div class="">
          <!-- <p>{{ bhajan.content }}</p> -->
